...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		...
		//System.out.println(getNeighbors(8) + "+" + getInNeighbors(8));
				
		for(int v = getNumVertices()-1; v >= 0; v--){
			degreeSequence.add(getNeighbors(v).size() + getInNeighbors(v).size());
		}
		
		
		return insertionSort(degreeSequence);
	}
	...
	public static void main (String[] args) {
		GraphLoader.createIntersectionsFile("data/maps/paichai.map", "data/intersections/paichai.intersections");
		...
		GraphLoader.loadRoadMap("D:/Works/Java/UCSDGraphs/data/maps/paichai.map", graphFromFile);
		...
		GraphAdjMatrix adjMatrix = new GraphAdjMatrix();
		GraphLoader.loadRoadMap("D:/Works/Java/UCSDGraphs/data/maps/paichai.map", adjMatrix);
		
		System.out.println(graphFromFile.getNeighbors(2));
		System.out.println(adjMatrix.getNeighbors2(0));
